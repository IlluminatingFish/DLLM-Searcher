#!/bin/bash
# Plan A: RL 训练全流程（rollout → DPO → eval）
# 用法: cd /research/cbim/vast/mz751/Projects/DLLM-Searcher && bash recipes/run_rl_plan_a.sh
set -e
...
ROLLOUT_DIR="$ROOT/dLLM_trainer/VRPO/output/rl/plan_a/rollouts"
DPO_DATA="$ROOT/dLLM_trainer/VRPO/data/dpo_pairs_plan_a.jsonl"
TRAIN_OUT="$ROOT/dLLM_trainer/VRPO/output/rl/plan_a/model"
EVAL_OUT="$ROOT/dLLM_trainer/VRPO/output/rl/plan_a/eval_100.jsonl"
LOG_DIR="$ROOT/dLLM_trainer/VRPO/output/rl/plan_a/logs"
