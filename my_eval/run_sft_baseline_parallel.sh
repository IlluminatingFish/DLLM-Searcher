#!/bin/bash
# sft_llada/ckpt_6 + 普通 block diffusion，100题，8GPU并行
# ablation 第1组：纯 SFT baseline（无 x0pred 训练）
...
OUTDIR="$ROOT/dLLM_trainer/VRPO/output/llada_eval/sft_baseline_parallel"
MERGED="$ROOT/dLLM_trainer/VRPO/output/llada_eval/sft_baseline_ckpt6_100.jsonl"
...
echo "=========================================="
echo "SFT baseline eval (普通 block diffusion) - 8 GPU 并行"
echo "模型: $MODEL"
echo "=========================================="
