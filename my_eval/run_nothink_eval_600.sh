#!/bin/bash
# nothink ckpt_8，600题（hotpot300+2wiki300），8GPU并行 eval
# 在 dionysos 上运行
...
OUTDIR="$ROOT/dLLM_trainer/VRPO/output/llada_eval/nothink_600_parallel"
MERGED="$ROOT/dLLM_trainer/VRPO/output/llada_eval/nothink_ckpt8_600.jsonl"
...
echo "=========================================="
echo "nothink ckpt_8 eval - 600题 - 8 GPU 并行"
echo "模型: $MODEL"
echo "输入: $INPUT"
echo "=========================================="
