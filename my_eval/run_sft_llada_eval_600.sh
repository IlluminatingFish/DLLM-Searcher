#!/bin/bash
# sft_llada ckpt_6，600题（hotpot300+2wiki300），8GPU并行 eval
# 在 dionysos 上运行（ablation study对照组）
...
OUTDIR="$ROOT/dLLM_trainer/VRPO/output/llada_eval/sft_llada_600_parallel"
MERGED="$ROOT/dLLM_trainer/VRPO/output/llada_eval/sft_llada_ckpt6_600.jsonl"
...
echo "=========================================="
echo "sft_llada ckpt_6 eval - 600题 - 8 GPU 并行"
echo "模型: $MODEL"
echo "输入: $INPUT"
echo "=========================================="
