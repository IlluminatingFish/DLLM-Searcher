#!/bin/bash
# Variant A: x0-prediction latent reasoning SFT
...
LOG_FILE="llada_sft_x0pred_$(hostname)_${TIMESTAMP}.log"
...
/research/cbim/vast/mz751/miniforge3/envs/dllm-rl/bin/accelerate launch \
  ...
  config=configs/sft_llada_x0pred.yaml 2>&1 | tee "$LOG_FILE"
