#!/bin/bash
# LLaDA x0pred SFT v2 — 修复短答案数据后重训
...
LOG_FILE="llada_sft_x0pred_v2_$(hostname)_${TIMESTAMP}.log"

echo "=============================="
echo "LLaDA x0pred SFT v2 (fixed short answers)"
...
/research/cbim/vast/mz751/miniforge3/envs/dllm-rl/bin/accelerate launch \
  ...
  config=configs/sft_llada_x0pred_v2.yaml 2>&1 | tee "$LOG_FILE"
