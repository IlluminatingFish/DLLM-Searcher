#!/bin/bash
# Variant B: auxiliary CE on think tokens SFT
...
LOG_FILE="llada_sft_think_ce_$(hostname)_${TIMESTAMP}.log"
...
/research/cbim/vast/mz751/miniforge3/envs/dllm-rl/bin/accelerate launch \
  ...
  train/sft_llada_think_ce.py \
  config=configs/sft_llada_think_ce.yaml 2>&1 | tee "$LOG_FILE"
