...
import torch
from transformers import AutoModel, AutoTokenizer, PreTrainedTokenizer, AutoModelForCausalLM
...
def get_model(model_args: ModelConfig, training_args:GRPOConfig) -> AutoModel:
    ...
    # if "SDAR" in model_args.model_name_or_path:
    ...
    #        **model_kwargs,
    #   )
    # if "Dream" in model.config.name_or_path:
